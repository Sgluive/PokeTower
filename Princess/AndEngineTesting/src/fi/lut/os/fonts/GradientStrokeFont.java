...
public class GradientStrokeFont extends GradientFont {
	...
	// endregion Fields
	// region Constructors
	public GradientStrokeFont(final FontManager pFontManager,
		...
		this(pFontManager, pTexture, pTypeface, pSize, pAntiAlias, pColorFrom
				.getARGBPackedInt(), pColorTo.getARGBPackedInt(), pStrokeWidth,
				pStrokeColorARGBPackedInt);
	}
	...
	public GradientStrokeFont(final FontManager pFontManager,
		...
		super(pFontManager, pTexture, pTypeface, pSize, pAntiAlias,
				pColorFromARGBPackedInt, pColorToARGBPackedInt);
	...
	public GradientStrokeFont(final FontManager pFontManager,
			...
			final float pSize, final boolean pAntiAlias, final Color[] pColors,
			final float pStrokeWidth, final Color pStrokeColor) {
		this(pFontManager, pTexture, pTypeface, pSize, pAntiAlias, pColors,
				pStrokeWidth, pStrokeColor.getARGBPackedInt());
	}

	public GradientStrokeFont(final FontManager pFontManager,
			final ITexture pTexture, final Typeface pTypeface,
			final float pSize, final boolean pAntiAlias,
			final int[] pColorsFromARGBPackedInt, final float pStrokeWidth,
			final int pStrokeColorARGBPackedInt) {
		super(pFontManager, pTexture, pTypeface, pSize, pAntiAlias,
				pColorsFromARGBPackedInt);
		this.mStrokeWidth = pStrokeWidth;
	...
	public GradientStrokeFont(final FontManager pFontManager,
		...
		this(pFontManager, pTexture, pTypeface, pSize, pAntiAlias,
				pColorsFromARGBPackedInt, pStrokeWidth, pStrokeColor
						.getARGBPackedInt());
	}
	...
	protected void updateTextBounds(final String pCharacterAsString) {
		this.mStrokePaint.getTextBounds(pCharacterAsString, 0, 1,
				this.mTextBounds);
	...
	protected void drawLetter(final String pCharacterAsString,
		...
		this.mCanvas.drawText(pCharacterAsString, pLeft
				+ Font.LETTER_TEXTURE_PADDING, pTop
				+ Font.LETTER_TEXTURE_PADDING, this.mStrokePaint);
	}
	// endregion Methods
}
